      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            setTimeout(() => setVisibility((v) => ({ ...v, logoSection: true })), 0);
            setTimeout(() => setVisibility((v) => ({ ...v, platforms: true })), 400);
            setTimeout(() => setVisibility((v) => ({ ...v, resources: true })), 800);
            setTimeout(() => setVisibility((v) => ({ ...v, company: true })), 1200);
            setTimeout(() => setVisibility((v) => ({ ...v, bottomBar: true })), 1600);
          } else {
            setVisibility({
              logoSection: false,
              platforms: false,
      ...
      <div className="border-t border-gray-200 bg-white py-16 dark:border-gray-800 dark:bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-16">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-12">
            <div className={`lg:col-span-4 ${isMobile ? "text-center" : ""} transition-all duration-1500 ease-in-out ${visibility.logoSection ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}>
              <div
              ...
              <p
                className={`mb-12 max-w-md text-gray-600 dark:text-gray-300 ${isMobile ? "mx-auto text-center" : "text-left"}`}
              >
                Bridging advanced technology for every sector serves as a powerful driver of transformative progress, delivering stronger productivity gains, enabling greater operational precision, and uncovering new pathways to profitability.
              </p>
              <div className="flex justify-center md:justify-start space-x-6">
                ...
                <a
                  ...
                  onMouseLeave={() => setHoveredLink(null)}
                  style={{ color: hoveredLink === "whatsapp" ? animatedColor : undefined, fontWeight: hoveredLink === "whatsapp" ? 'bold' : 'normal' }}
                  className={`h-6 w-6 flex items-center justify-center ${hoveredLink !== "whatsapp" ? "text-gray-600 dark:text-gray-300" : ""}`}
                  aria-label="WhatsApp"
                >
                  <svg className={`h-6 w-6 ${hoveredLink === "whatsapp" ? "scale-150 transition-transform duration-300" : ""}`} fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div
                className={`md:order-1 lg:order-2 min-w-[150px] ${isMobile ? "text-center" : "lg:text-left"} transition-all duration-1500 ease-in-out ${visibility.platforms ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}
              >
              ...
              <div
                className={`md:order-2 lg:order-3 min-w-[150px] ${isMobile ? "text-center" : "lg:text-left"} transition-all duration-1500 ease-in-out ${visibility.resources ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}
              >
                <h3 className="mb-6 font-semibold text-gray-900 dark:text-white text-center sm:text-left">
                  Resources
                </h3>
              ...
              <div
                className={`md:order-last lg:order-4 min-w-[150px] ${isMobile ? "text-center" : "lg:text-left"} transition-all duration-1500 ease-in-out ${visibility.company ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}
              >
                <h3 className="mb-6 font-semibold text-gray-900 dark:text-white text-center sm:text-left">
                  Company
                </h3>
          ...
          {isMobile ? (
            <div className={`mt-16 flex flex-col items-center justify-between border-t border-gray-200 pt-10 md:flex-row dark:border-gray-800 transition-all duration-1500 ease-in-out ${visibility.bottomBar ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}>
